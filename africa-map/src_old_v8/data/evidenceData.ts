...
export const EVIDENCE: PillarEvidence[] = [
  ...
  {
    pillarId: 'businessEnv',
    summary: 'Business environment quality — including sanctions exposure, nationalisation risk, and competition law — is a critical but often underweighted investment determinant in Africa.',
    keyInsight: 'The Economist (March 2026) identifies firm growth constraints as the core driver of economic divergence: countries where productive firms cannot scale (due to tax cliff edges, weak credit, labour law disincentives, and poor competition frameworks) stagnate regardless of macro conditions. In Africa, active resource nationalism in the Sahel and DRC significantly raises expropriation risk — Mali nationalised Barrick Gold\'s Loulo-Gounkoto complex (Dec 2024, $1.9bn lost revenue); Burkina Faso seized five gold mines below market value; Niger revoked Orano\'s uranium licence. UN sanctions are active against CAR, DRC, Libya, Mali, Somalia, South Sudan, and Sudan. Countries with excellent business environments (Rwanda, Mauritius, Botswana) consistently outperform on FDI per capita.',
    confidence: 'strong',
    dataSource: 'OFAC/UN/EU sanctions lists (2025/2026); Fraser Institute Annual Survey of Mining Companies 2025; GIS Reports resource nationalism tracker; Hogan Lovells ICSID arbitration data; Grant Thornton Africa mining risk report 2025; The Economist "The third way in development economics" (March 2026)',
    citations: [
      {
        authors: 'The Economist',
        year: 2026,
        title: 'To understand why countries grow, look at their firms — The third way in development economics',
        journal: 'The Economist, Finance & Economics (March 7th 2026)',
        finding: 'Countries where productive firms fail to grow stagnate. Key barriers: tax systems that reward staying small, labour laws that discourage hiring, weak credit. Hsieh & Klenow find US factories 40+ years old employ 7x more workers than new ones; in India they barely grow. Removing distortions could raise Indian productivity by 60%. Management quality strongly linked to productivity and can be improved.',
      },
      {
        authors: 'GIS Reports',
        year: 2025,
        title: 'Africa\'s new resource nationalism',
        journal: 'GIS Reports Online',
        finding: 'Nearly half of African nations have imposed bans or restrictions on raw mineral exports. Mali, Burkina Faso, Niger represent most aggressive Sahel nationalisation wave. Botswana-De Beers renegotiation (2025) shows more cooperative model. DRC cobalt JV renegotiation sought 70% state stake.',
      },
      {
        authors: 'Hogan Lovells',
        year: 2024,
        title: 'Mining in Africa: Navigating risk amidst the wave of political change',
        journal: 'Hogan Lovells Publications',
        finding: '48 new ICSID cases commenced in 2024, nearly 20% related to mining concessions. Tanzania (3 cases), DRC (3 cases), Mali (2), Mozambique (2), Zambia, Sierra Leone among recent respondents. Resource nationalism most acute where critical transition minerals are concentrated.',
      },
      {
        authors: 'Sanction Scanner / OFAC / UN',
        year: 2026,
        title: 'List of Sanctioned Countries by OFAC, UN, and EU (2026)',
        journal: 'Sanction Scanner; OFAC Treasury; UN Security Council',
        finding: 'UNSC-sanctioned African countries: Somalia, Libya, Mali, Sudan, South Sudan, CAR, DRC, Eritrea, Guinea-Bissau. No African country faces comprehensive OFAC embargo (Sudan has targeted comprehensive sanctions on certain entities). Burkina Faso, Guinea, Niger, Ethiopia face targeted individual sanctions post-coups.',
      },
      {
        authors: 'Fraser Institute',
        year: 2025,
        title: 'Annual Survey of Mining Companies 2025',
        journal: 'Fraser Institute',
        finding: 'Six African countries in global bottom 10 for mining policy attractiveness: Mali, Burkina Faso, Guinea, South Africa, DRC, Angola. Zimbabwe ranked least attractive globally. Ghana, Botswana, Namibia, Egypt among more predictable frameworks.',
      },
    ],
    yourDataNote: 'Scored from: Nationalisation risk (40% weight — based on expropriation history, current policy signals, ICSID arbitration record); Sanctions level (25% — OFAC/UN/EU status mapped to 0-100); Competition law quality (35% — framework quality, enforcement, firm growth enablement scored 1-10 per The Economist framework). Sources: OFAC 2026, UN Security Council, GIS Reports, Fraser Institute 2025, Hogan Lovells, Grant Thornton.',
  },
];
